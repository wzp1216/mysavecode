...
class AI_TEST(object):
    ...
    # 备用信息，若未识别到，则执行该数据
    mission = json.loads(
        '{"Grab":{"apple_box":0,"apple_box1":0,"pear_box":1,"eggplant_box":2},"Grab_area_leftrear":[1,1],"Grab_area_rightfront":[17,15]'+
        ',"box1":[20.3618, 13.0644, 0.5],"box2":[20.3668, 8.1924, 0.5],"box3":[20.3668, 3.0560, 0.5]}')
    ...
    def start_mission(self):
        ...
        for i in range(len(self.mission["Grab"])):
            ...
            elif "eggplant_box" in self.mission["Grab"] and (eggbox < 1) and (drone.eggplant_box_pose != None):
                eggbox=eggbox+1
