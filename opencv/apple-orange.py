...
plt.subplot(2,2,3),plt.imshow(real,cmap='viridis')
plt.title('add-sample'),plt.xticks([]),plt.yticks([])
plt.subplot(2,2,4),plt.imshow(ls_,cmap='viridis')
plt.title('add-good'),plt.xticks([]),plt.yticks([])
