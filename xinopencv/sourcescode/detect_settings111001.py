...
# Form implementation generated from reading ui file '检测设置界面1109.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.spinBox.setGeometry(QtCore.QRect(90, 180, 71, 31))
        self.spinBox.setMaximum(255)
        self.spinBox.setObjectName("spinBox")
        self.spinBox_2 = QtWidgets.QSpinBox(self.tab_2)
        self.spinBox_2.setGeometry(QtCore.QRect(170, 180, 71, 31))
        self.spinBox_2.setMaximum(1000)
        self.spinBox_2.setObjectName("spinBox_2")
        self.spinBox_3 = QtWidgets.QSpinBox(self.tab_2)
        self.spinBox_3.setGeometry(QtCore.QRect(90, 230, 71, 31))
        self.spinBox_3.setMaximum(255)
        self.spinBox_3.setObjectName("spinBox_3")
        self.spinBox_4 = QtWidgets.QSpinBox(self.tab_2)
        self.spinBox_4.setGeometry(QtCore.QRect(170, 230, 71, 31))
    ...
    def set_para(self):
        ...
        value_ce = self.spinBox_3.value()
        c_duan = self.spinBox_2.value()
        c_ce = self.spinBox_4.value()
        ...
        if yzfg_duan == 'Global':
            c_duan = '0'
        print(value_duan, value_ce, c_ce, c_duan, min_ce, min_duan, method_duan, method_ce, yzfg_ce, yzfg_duan, sample,
              block)
    ...
    def get_para(self):
        ...
        self.spinBox_2.setValue(int(c_duan))
        self.spinBox_3.setValue(int(value_ce))
        self.spinBox_4.setValue(int(c_ce))
        self.doubleSpinBox.setValue(float(min_duan))
        self.doubleSpinBox_2.setValue(float(min_ce))
